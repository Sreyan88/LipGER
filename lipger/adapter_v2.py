...
import lipger
from lipger.adapter import GPT as BaseModel
from lipger.adapter import Block as BaseBlock
from lipger.adapter import CausalSelfAttention as BaseCausalSelfAttention
from lipger.adapter import Config as BaseConfig
from lipger.model import KVCache
from lipger.utils import map_old_state_dict_weights
...
class Config(BaseConfig):
    ...
    def mlp_class(self) -> Type:
        return getattr(lipger.adapter_v2, self._mlp_class)
...
class GptNeoxMLP(lipger.model.GptNeoxMLP):
    def __init__(self, config: Config) -> None:
        nn.Module.__init__(self)
...
class LLaMAMLP(lipger.model.LLaMAMLP):
    def __init__(self, config: Config) -> None:
        nn.Module.__init__(self)
